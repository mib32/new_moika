...
(function(wysihtml5) {
  var /**
       ...
       */
      IGNORE_URLS_IN        = wysihtml5.lang.array(["IFRAME","CODE", "PRE", "A", "SCRIPT", "HEAD", "TITLE", "STYLE"]),
      /**
       * revision 1:
       *    /(\S+\.{1}[^\s\,\.\!]+)/g
       *
  ...
  function _wrapMatchesInNode(textNode) {
    ...
    if (textNode.data.match(/<iframe/) == null){
        tempElement.innerHTML = "<span></span>" + _convertUrlsToLinks(textNode.data);
    }else{
        tempElement.innerHTML = "<span></span>" + textNode.data;
    }
