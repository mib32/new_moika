class ReviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @review.save
        ...
        format.html { redirect_to car_wash_reviews_path(@car_wash), notice: 'Review was successfully created.' }
  ...
  private
    ...
    def review_params
      params.require(:review).permit(:text, :rating, :car_wash_id, images_attributes: [:image])
    end
end
